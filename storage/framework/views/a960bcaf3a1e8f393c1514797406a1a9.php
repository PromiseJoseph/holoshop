...
<head>
  ...
  <link href="<?php echo e(URL('storage/vendor/swiper/swiper-bundle.min.css')); ?>" rel="stylesheet">
    ...
    <link href="<?php echo e(asset('storage/css/rest_Dash.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('storage/css/logs.css')); ?>" rel="stylesheet">
     <!-- Scripts -->
 ...
 <?php echo $__env->yieldContent('headLink'); ?> <!-- + title etc -->
    <style>
      .bd-placeholder-img {
        font-size: 1.125rem;
        text-anchor: middle;
...
</html><?php /**PATH C:\xampp\htdocs\laravel\Holoshop\resources\views/layouts/logslayout.blade.php ENDPATH**/ ?>