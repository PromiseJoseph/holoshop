...
<head>
    ...
    <title>{{ config('app.name', 'Holoshop') }}</title>
    <link href="assets/img/favicon.png" rel="icon">


  <!-- Vendor CSS Files -->
  <link href="{{ URL('storage/vendor/animate.css/animate.min.css')}}" rel="stylesheet">
  ...
  <link href="{{ URL('storage/css/style.css')}}" rel="stylesheet">
    ...
    <link href="{{ URL('storage/css/index.css')}}" rel="stylesheet">
...
@endauth
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    <div class="container">
      ...
      <a class="navbar-brand text-brand" href="{{ route('index.auth') }}">
      ...
      <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link mx-1 " aria-expanded="false" href="{{route('index.auth')}}"> <i class="bi bi-house-fill " ></i>  Home</a>
          </li>

          <li class="nav-item d-flex ">
            <a  class="nav-link  mx-1" aria-expanded="false" href="{{route('cart.index')}}">  <i class="bi bi-cart4 " ></i>  Cart <span id="cartquantity">0</span> </a> 
          </li>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle mx-1"  id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="bi bi-view-stacked" ></i>  Categories</a>
              <div class="dropdown-menu">
                @auth
                <a class="dropdown-item " href="{{route('categories',[ 'category' => 'phones and gadgets' ])}}" >Phones and Gadgets</a>
                <a class="dropdown-item " href="{{route('categories',[ 'category' => 'wears' ])}}">Wears</a>
                <a class="dropdown-item " href="{{route('categories',[ 'category' => 'electronics' ])}}">Electronics</a>
                <a class="dropdown-item " href="{{route('categories',[ 'category' => 'shoes' ])}}">Shoes</a>
                @endauth
                @guest
          ...
          <!-- user id  -->
          @auth
          <p class="hidden" id="idIdentifier" data-id="{{Auth::user()->id}}"></p>
          @endauth 
        ...
        <div class="col-sm-12 col-md-4">
          <div class="widget-a">
            <div class="w-header-a">
              <h3 class="w-title-a text-brand">{{ config('app.name', 'Holoshop') }}</h3>
            </div>
            <div class="w-body-a">
        ...
        <div class="col-md-12">
          ...
          <div class="copyright-footer">
            <p class="copyright color-text-a">
              &copy; Copyright
              <span class="color-a">{{ config('app.name', 'Holoshop') }}</span> All Rights Reserved.
            </p>
          </div>
          <div class="credits">
            <!--
